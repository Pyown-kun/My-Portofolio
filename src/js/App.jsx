          ...
          >
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-background rounded-lg bg-background md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-background dark:bg-background md:dark:bg-background dark:border-background">
              <li>
                <a
                  href="#"
                  class="group block mx-10 py-2 px-3 md:p-0 text-text rounded md:hover:bg-transparent md:hover:text-background md:dark:hover:text-background dark:text-text  dark:hover:text-background md:dark:hover:bg-transparent dark:border-background"
                >
                  <img
                    src=".\public\image\Rectangle 6.png"
                    alt=""
                    class="opacity-0 group-hover:opacity-100 fixed "
                  />
                  <h1 class="relative left-7 z-10">HOME</h1>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <img
                    ...
                    class="opacity-0 group-hover:opacity-100 fixed "
                  />
                  <h1 class="relative left-6 z-10">ABOUT</h1>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <img
                    ...
                    class="opacity-0 group-hover:opacity-100 fixed "
                  />
                  <h1 class="relative left-5 z-10">PROJECT</h1>
                </a>
              </li>
            </ul>
          </div>
